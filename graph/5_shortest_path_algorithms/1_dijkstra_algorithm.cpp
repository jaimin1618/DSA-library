...
// use case
// Finds shortest path in weighted directed/undirected graph
// graph must not has negative edges - otherwise it would keep running and will not end up anywhere. 
// beware of negative weight cycles.
// Key point: dijkstra is greedy algorithm. 
